...
Solve the task and commit your code. Commit often, we like to see small commits that build up to the end result of your test, instead of one final commit with all the code.
Do a pull request from the dev branch to the master branch. More on that right below.
Reply to the thread you are having with our HR department so we can start reviewing your code.
